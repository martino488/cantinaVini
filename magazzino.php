...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL ?>/assets/css/magazzino.css">
...
<body>
    <div class="form-container">
        <form action="magazzino.php" method="POST">
            ...
            <input type="text" name="nome" placeholder="Aggiungi nome Vino"><br>
        ...
        <textarea class="descrizione" name="descrizione" id="descrizione" placeholder="Inserisci la descrizione"></textarea>
